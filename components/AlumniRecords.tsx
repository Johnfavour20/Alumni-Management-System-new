  ...
  return (
    <div className="p-4 lg:p-8">
      ...
      <div className="flex justify-between items-center mb-6">
        <p className="text-gray-600 dark:text-gray-400">Showing {filteredAlumni.length} of {isStudentView ? alumni.filter(a => a.openToMentoring).length : alumni.length} alumni</p>
